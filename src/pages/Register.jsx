...
export default function Register() {
  ...
  const handlePasswordChange = (field, value) => {
    ...
    } else if (field === 'confirmPassword' && updatedForm.password) {
      setPasswordMatch(updatedForm.password === updatedForm.confirmPassword);
    }
  };
    ...
    <div className="min-h-screen bg-gray-900 text-gray-200 flex items-center justify-center p-4">
      <div className="max-w-md w-full space-y-8">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div className="space-y-5">
              ...
              <div>
                ...
                <div className="relative group">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none group-focus-within:text-emerald-400 transition-colors">
                    <UserIcon className="h-5 w-5 text-gray-500 group-focus-within:text-emerald-400" />
                  </div>
                  <input
                    id="username"
                    type="text"
                    required
                    className="appearance-none block w-full px-3 py-3 pl-10 bg-gray-900/50 border border-gray-700 rounded-xl placeholder-gray-500 text-white focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all duration-200"
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    required
                    className="appearance-none block w-full px-3 py-3 pl-10 pr-10 bg-gray-900/50 border border-gray-700 rounded-xl placeholder-gray-500 text-white focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all duration-200"
              ...
              <div>
                ...
                <div className="relative group">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none group-focus-within:text-emerald-400 transition-colors">
                    <ShieldCheckIcon className="h-5 w-5 text-gray-500 group-focus-within:text-emerald-400" />
                  </div>
                  <input
                    id="confirmPassword"
                    type={showConfirmPassword ? "text" : "password"}
                    required
                    className={`appearance-none block w-full px-3 py-3 pl-10 pr-12 bg-gray-900/50 border ${passwordMatch ? 'border-gray-700' : 'border-red-500'} rounded-xl placeholder-gray-500 text-white focus:outline-none focus:ring-2 ${passwordMatch ? 'focus:ring-emerald-500' : 'focus:ring-red-500'} focus:border-transparent transition-all duration-200`}
            ...
            <div className="flex items-center">
              <input
                ...
                type="checkbox"
                required
                className="h-4 w-4 text-emerald-600 focus:ring-emerald-500 border-gray-600 rounded bg-gray-900"
              />
            ...
            {/* <div className="grid grid-cols-2 gap-3">
              <button
                type="button"
                className="w-full inline-flex justify-center items-center py-3 px-4 border border-gray-700 rounded-xl text-sm font-medium text-white bg-gray-900/50 hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 transition-all duration-200"
              >
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-center">
          <div className="text-white p-4 rounded-xl bg-gray-800/50 backdrop-blur-sm">
