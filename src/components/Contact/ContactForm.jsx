...
const ContactForm = () => {
  ...
  const handleFileChange = (e) => {
    ...
    if (error) setError("");
    // Reset input value so same file can be selected again if removed later
    e.target.value = null;
  };
  ...
  return (
    <section
      className="py-16 sm:py-20 md:py-24 bg-gradient-to-b from-gray-900 to-gray-950"
      id="contact"
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 sm:mb-16">
          ...
          <h2 className="text-3xl xs:text-4xl sm:text-5xl md:text-6xl font-black text-white mb-4 leading-tight">
            Connect With{" "}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-primary via-white to-brand-secondary  text-white">
              Our Team
            </span>
          </h2>
          <p className="text-gray-400 text-lg sm:text-xl max-w-3xl mx-auto font-light leading-relaxed">
            Have questions or ready to begin your fitness journey? Our expert
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-green-300 text-sm sm:text-base mt-1">
                          Thank you for contacting FITLYF. Our team will respond
                          within 24 hours.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="mb-6 p-4 sm:p-6 bg-gradient-to-r from-red-900/30 to-rose-900/30 backdrop-blur-sm border border-red-700/50 rounded-xl">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-red-300 text-sm sm:text-base mt-1">
                          {error}
                        </p>
                      </div>
                    </div>
              ...
              <div className="relative">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div
                      key={index}
                      className="p-3 hover:bg-gray-800/30 rounded-xl transition-colors duration-300"
                    >
