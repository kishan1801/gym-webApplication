...
const AddMembershipForm = () => {
  ...
  useEffect(() => {
    if (currentUser && currentUser.role !== 'admin') {
      // console.log('Non-admin user trying to access membership creation, redirecting...');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await API.post('/memberships/add', submissionData);
      ...
      const errorMessage = error.response?.data?.message || error.response?.data?.error || 'Failed to add membership';
      alert(errorMessage);
    } finally {
      setSubmitting(false);
    }
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-white mb-2">Add New Membership</h1>
              <p className="text-gray-400">Create a new membership plan for your gym (Prices in ₹ INR)</p>
